...
namespace BlazorNotify.Utils
{
    public static class VapidHelper
    {
        ...
        public static VapidDetails GenerateVapidKeys()
        {
            ...
            results.PublicKey = publicKey.FromBase64();
            results.PrivateKey = ByteArrayPadLeft(privateKey, 32).FromBase64();
            ...
            string privateKey, long expiration = -1)
        {
            ...
            var decodedPrivateKey = privateKey.ToBase64();
        ...
        public static void ValidatePublicKey(string publicKey)
        {
            ...
            var decodedPublicKey = publicKey.ToBase64();
